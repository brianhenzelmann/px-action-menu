...
function runBaseTests() {
  px_action_menu_1 = document.getElementById('px_action_menu_1');

  suite('Base Automation Tests for px-action-menu', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-action-menu fixture is created', function() {
      assert.isTrue(document.getElementById('px_action_menu_1') !== null);
    });
